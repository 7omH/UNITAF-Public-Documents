...
force ace_csw_ammoHandling = 2; //Allow mission override
force ace_csw_defaultAssemblyMode = true; //Allow mission override
...
force force acex_field_rations_hudShowLevel = 50;
force force acex_field_rations_hudTransparency = -1;
force force acex_field_rations_hudType = 1;
...
force force acex_field_rations_thirstQuenched = 2.95295;
force force acex_field_rations_timeWithoutFood = 3;
force force acex_field_rations_timeWithoutWater = 1.8;
...
force force ace_hearing_explosionDeafnessCoefficient = 0.05;
...
force force ace_interact_menu_menuAnimationSpeed = 1;
...
force force ace_killtracker_trackAI = false;
...
force force ace_map_gestures_defaultColor = [0.1,0.1,0.1,1];
force force ace_map_gestures_defaultLeadColor = [1,0.496138,0,1];
...
force force ace_map_gestures_nameTextColor = [0.102495,0.102495,0.1,1];
...
force ace_medical_AIDamageThreshold = 1; //Allow mission override for AI Uncon
...
force ace_medical_statemachine_AIUnconsciousness = false; //Allow mission override for AI Uncon
...
force force ace_medical_treatment_timeCoefficientPAK = 0.4;
...
force force ace_medical_treatment_treatmentTimeIV = 4;
...
force force ace_medical_treatment_woundReopenChance = 0.7;
force force ace_medical_treatment_woundStitchTime = 4;

// ACE Name Tags
force force ace_nametags_ambientBrightnessAffectViewDist = 1;
force force ace_nametags_defaultNametagColor = [1,1,1,0.25104];
force force ace_nametags_nametagColorBlue = [0.2,0.2,1,0.8];
force force ace_nametags_nametagColorGreen = [0.2,1,0.2,0.800653];
force force ace_nametags_nametagColorMain = [1,1,1,1];
force force ace_nametags_nametagColorRed = [1,0.2,0.2,0.904635];
force force ace_nametags_nametagColorYellow = [1,1,0.199049,0.7041];
force force ace_nametags_playerNamesMaxAlpha = 0.8;
force force ace_nametags_playerNamesViewDistance = 1;
...
force force ace_overheating_unJamFailChance = 0.496138;
...
force force ace_quickmount_speed = 15.1069;
...
force force ace_repair_repairDamageThreshold = 0.7041;
force force ace_repair_repairDamageThreshold_engineer = 0.399584;
...
// ACE Trenches
force force ace_trenches_bigEnvelopeDigDuration = 50;
force force ace_trenches_bigEnvelopeRemoveDuration = 30;
force force ace_trenches_smallEnvelopeDigDuration = 40;
force force ace_trenches_smallEnvelopeRemoveDuration = 24;
...
force force diwako_dui_indicators_rangeLimit = 60;
...
// Fish Camo Cream
force force fish_camo_cream_common_application_time = 10;
...
kat_airway_checkbox_puking_sound = true; //Allow clientside disable
force force kat_airway_enable = true;
force force kat_airway_Guedeltubus_time = 3.15;
...
force force kat_breathing_BVMOxygen_Multiplier = 2.47211;
...
force force kat_breathing_deterioratingPneumothorax_interval = 1;
...
force force kat_circulation_AdvRhythm_deteriorateTimeWeight = 240;
...
force force kat_circulation_AED_X_Monitor_SpO2Warning = 40;
...
force force kat_circulation_blood_drawTime_250ml = 20;
force force kat_circulation_blood_drawTime_500ml = 40;
...
force force kat_circulation_Defibrillator_DistanceLimit = 9.95;
...
force force kat_circulation_deterioratingTamponade_interval = 3600;
...
force force kat_pharma_IVdrop = 360;
...
force force kat_pharma_medLvl_Naloxone = 2;
...
force force kat_pharma_reorientationChance = 51.5094;
...
force kat_vitals_enableSimpleMedical = true; //Allow mission override for AI Uncon
...
force unitaf_tablet_Oops_GPS = "disabled";
force unitaf_tablet_Oops_NVG = "disabled";
force unitaf_tablet_Oops_NVG_Classname = "NVGoggles";
force unitaf_tablet_Oops_Radio = "orbat_range";
force unitaf_tablet_Oops_Radio_Classname = "TFAR_anprc152";
force unitaf_tablet_ORBAT_Range = 20;

// VET_Unflipping
force force vet_unflipping_require_serviceVehicle = false;
force force vet_unflipping_require_toolkit = true;
force force vet_unflipping_time = 60;
